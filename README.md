...
- [laravel/octane](https://github.com/laravel/octane) - Supercharge your Laravel application&#39;s performance. (4 weeks ago)
...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.1.46](https://github.com/filamentphp/filament/releases/tag/v3.1.46), 3 days ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/octane](https://github.com/laravel/octane) ([v2.2.7](https://github.com/laravel/octane/releases/tag/v2.2.7), 6 days ago) - Supercharge your Laravel application&#39;s performance.
