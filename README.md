...
- [KennedyTedesco/meilisearch-search-filter](https://github.com/KennedyTedesco/meilisearch-search-filter) - A fluent and intuitive way to construct filters for Meilisearch queries. (5 days ago)
...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.0.39](https://github.com/filamentphp/filament/releases/tag/v3.0.39), 3 days ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [KennedyTedesco/meilisearch-search-filter](https://github.com/KennedyTedesco/meilisearch-search-filter) ([v1.0](https://github.com/KennedyTedesco/meilisearch-search-filter/releases/tag/v1.0), 5 days ago) - A fluent and intuitive way to construct filters for Meilisearch queries.
