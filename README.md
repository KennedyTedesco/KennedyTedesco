...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.1.22](https://github.com/filamentphp/filament/releases/tag/v3.1.22), 2 days ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/framework](https://github.com/laravel/framework) ([v10.37.3](https://github.com/laravel/framework/releases/tag/v10.37.3), 3 days ago) - The Laravel Framework.
