...
- [laravel/framework](https://github.com/laravel/framework) ([v10.30.0](https://github.com/laravel/framework/releases/tag/v10.30.0), today) - The Laravel Framework.
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.0.88](https://github.com/filamentphp/filament/releases/tag/v3.0.88), 1 day ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
