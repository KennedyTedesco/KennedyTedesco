...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.1.20](https://github.com/filamentphp/filament/releases/tag/v3.1.20), today) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/framework](https://github.com/laravel/framework) ([v10.37.1](https://github.com/laravel/framework/releases/tag/v10.37.1), today) - The Laravel Framework.
