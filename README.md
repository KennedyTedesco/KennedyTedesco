...
- [laravel/octane](https://github.com/laravel/octane) ([v2.3.0](https://github.com/laravel/octane/releases/tag/v2.3.0), 2 days ago) - Supercharge your Laravel application&#39;s performance.
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.2.2](https://github.com/filamentphp/filament/releases/tag/v3.2.2), 3 days ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
