...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.2.42](https://github.com/filamentphp/filament/releases/tag/v3.2.42), 3 days ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/octane](https://github.com/laravel/octane) ([v2.3.4](https://github.com/laravel/octane/releases/tag/v2.3.4), 6 days ago) - Supercharge your Laravel application&#39;s performance.
- [dunglas/frankenphp](https://github.com/dunglas/frankenphp) ([v1.1.0](https://github.com/dunglas/frankenphp/releases/tag/v1.1.0), 4 weeks ago) - 🧟 The modern PHP app server
