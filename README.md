...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.2.6](https://github.com/filamentphp/filament/releases/tag/v3.2.6), 1 day ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/octane](https://github.com/laravel/octane) ([v2.3.0](https://github.com/laravel/octane/releases/tag/v2.3.0), 4 days ago) - Supercharge your Laravel application&#39;s performance.
