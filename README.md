...
- [filamentphp/filament](https://github.com/filamentphp/filament) ([v3.1.23](https://github.com/filamentphp/filament/releases/tag/v3.1.23), 1 day ago) - A collection of beautiful full-stack components for Laravel. The perfect starting point for your next app. Using Livewire, Alpine.js and Tailwind CSS.
- [laravel/framework](https://github.com/laravel/framework) ([v10.37.3](https://github.com/laravel/framework/releases/tag/v10.37.3), 4 days ago) - The Laravel Framework.
- [laravel/octane](https://github.com/laravel/octane) ([v2.1.2](https://github.com/laravel/octane/releases/tag/v2.1.2), 2 weeks ago) - Supercharge your Laravel application&#39;s performance.
